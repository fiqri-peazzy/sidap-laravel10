...
@section('content')
    <div class="container-fluid">
        ...
        <div class="alert alert-info">
            <i class="fas fa-info-circle"></i> Data yang Anda kirim akan masuk ke sistem dan menunggu verifikasi oleh
            verifikator PPLP.
        </div>
            ...
            <div class="col-lg-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Tambah Atlet</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('sekolah.atlit.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @error('email')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <small class="form-text text-muted">Jika diisi, akan otomatis dibuatkan
                                                    akun user untuk login</small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="riwayat[0][tahun]" value="{{ date('Y') }}">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <a href="{{ route('sekolah.atlit.index') }}" class="btn btn-secondary">
