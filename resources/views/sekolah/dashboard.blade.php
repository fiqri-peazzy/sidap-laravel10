                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">Belum ada data atlet. Silakan tambahkan data
                                        atlet binaan sekolah Anda.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
                <a href="{{ route('sekolah.atlit.index') }}" class="btn btn-sm btn-outline-primary">Lihat Semua Data
                    Atlet</a>
            </div>
        </div>
    </div>
